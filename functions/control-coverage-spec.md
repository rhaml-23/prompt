...
| -------------- | -------------------------------------- | ------------------------- | -------------------------------------- |
| Standard (2.0) | hds, iso42001, customer-portal-ugc-sso | `control_coverage`        | `families[]` + `totals`                |
| Legacy (1.1)   | 62443                                  | `control_coverage_matrix` | flat `controls[]` + `coverage_summary` |
...
- Normalised by: `scripts/auditor_view_renderer.py._normalize_coverage()`, `scripts/program_dashboard_renderer.py._normalize_coverage()`
